package co.odisea.features.store.perks.chat;

import co.odisea.api.common.annotations.Async;
import co.odisea.api.mongodb.models.nickname.*;
...
import co.odisea.framework.exceptions.postconfigured.*;
...
import static co.odisea.features.store.perks.chat.NicknameCommand.PERMISSION;
