...
import co.odisea.features.menus.api.opener.ChestInventoryOpener;
import co.odisea.features.menus.api.opener.InventoryOpener;
import co.odisea.features.menus.api.opener.SpecialInventoryOpener;
...
public class InventoryManager implements Listener {
	...
	public void onInventoryDrag(InventoryDragEvent event) {
		...
		if (clickedContents == null) {
			Shield.log("Could not find clicked inventory");
			Thread.dumpStack();
			return;
		}
