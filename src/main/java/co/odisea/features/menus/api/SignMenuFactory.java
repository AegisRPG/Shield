...
import co.odisea.utils.MathUtils;
...
public final class SignMenuFactory {
	...
	public static final class Menu {
		...
		public void open(Player player) {
			...
			Shield.getSignMenuFactory().signLocations.put(player, position);
			Shield.getSignMenuFactory().inputReceivers.putIfAbsent(player, this);
		}
	}
}
