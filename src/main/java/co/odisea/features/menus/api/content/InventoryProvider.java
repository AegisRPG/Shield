package co.odisea.features.menus.api.content;

import co.odisea.Shield;
import co.odisea.features.menus.api.*;
import co.odisea.features.menus.api.SmartInventory.Builder;
import co.odisea.features.menus.api.TemporaryMenuListener.CustomInventoryHolder;
import co.odisea.features.menus.api.annotations.Rows;
import co.odisea.features.menus.api.annotations.Title;
import co.odisea.features.menus.api.annotations.Uncloseable;
...
import static co.odisea.utils.MaterialTag.ARROWS;
