package co.odisea.features.chat.alerts;
...
import co.odisea.models.alerts.Alerts.Highlight;
import co.odisea.models.alerts.Alerts;
import co.odisea.models.alerts.AlertsService;
...
public class AlertsCommand extends CustomCommand {
    ...
    public void help() {
        new JsonBuilder(PREFIX)
                .next("&3Receive a &e'ping' noise &3whenever a word or phrase in your &c/alerts list &^3 is said in chat. ")
