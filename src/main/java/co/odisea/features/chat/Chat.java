...
import co.odisea.*;
import co.odisea.features.chat.alerts.AlertsListener;
import co.odisea.features.chat.bridge.IngameBridgeListener;
import co.odisea.features.chat.events.PublicChatEvent;
import co.odisea.features.chat.translator.Translator;
import co.odisea.framework.features.*;
...
import static co.odisea.utils.AdventureUtils.asLegacyText;
...
public class Chat extends Feature {
    ...
    public void onStart() {
        ...
        new Timer("    Chat.ChatListener", () -> Shield.registerListener(new ChatListener()));
        new Timer("    Chat.IngameBridgeListener", () -> Shield.registerListener(new IngameBridgeListener()));
        new Timer("    Chat.AlertsListener", () -> Shield.registerListener(new AlertsListener()));
        new Timer("    Chat.Translator", () -> Shield.registerListener(new Translator()));
...
//                .disabledWorldGroups(List.of(WorldGroup.MINIGAMES))
    ...
    public static int getLocalRadius() {
        return Shield.getInstance().getConfig().getInt("localRadius");
    }
