...
public enum WoodType {
    OAK(World.Environment.NORMAL),
    SPRUCE(World.Environment.NORMAL),
    BIRCH(World.Environment.NORMAL),
    JUNGLE(World.Environment.NORMAL),
    ACACIA(World.Environment.NORMAL),
    DARK_OAK(World.Environment.NORMAL),
    MANGROVE(World.Environment.NORMAL) {
        @Override
        public Material getSapling() {
            return Material.MANGROVE_PROPAGULE;
        }
    },
    CRIMSON(World.Environment.NETHER),
    WARPED(World.Environment.NETHER),
    CHERRY(World.Environment.NORMAL)
    ;

    WoodType(World.Environment environment) {
