...
import co.odisea.utils.ItemBuilder.ModelId;
...
public class ItemUtils {
    ...
    public static boolean isSameHead(ItemStack itemStack1, ItemStack itemStack2) {
        ...
        return Shield.getHeadAPI().getItemID(itemStack1).equals(Shield.getHeadAPI().getItemID(itemStack2));
    }
    ...
    public static Material getDimensionDisplayMaterial(World.Environment dimension) {
