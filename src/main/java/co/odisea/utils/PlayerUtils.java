...
import co.odisea.features.vanish.*;
import co.odisea.models.mail.Mailer.Mail;
import co.odisea.features.commands.staff.WorldGuardEditCommand;
...
import co.odisea.api.common.utils.Utils.MinMaxResult;
...
import co.odisea.models.mail.MailerService;
import co.odisea.models.nerd.*;
...
import static co.odisea.api.common.utils.UUIDUtils.isUuid;
import static co.odisea.api.common.utils.Utils.getMin;
import static co.odisea.utils.Distance.distance;
import static co.odisea.utils.ItemUtils.fixMaxStackSize;
import static co.odisea.utils.Nullables.isNullOrAir;
import static co.odisea.utils.StringUtils.stripColor;
    ...
    public static class HidePlayer {
        ...
        public void from(Collection<? extends OptionalPlayer> players) {
            ...
            players.stream()
                    ...
                    .forEach(player -> player.getPlayer().hidePlayer(Shield.getInstance(), this.player));
        }
    }
    ...
    public static class ShowPlayer {
        ...
        public void to(Collection<? extends OptionalPlayer> players) {
            ...
            players.stream()
                    ...
                    .filter(Objects::nonNull)
                    .filter(player -> !player.getUniqueId().equals(this.player.getUniqueId()))
                    .forEach(player -> player.showPlayer(Shield.getInstance(), this.player));
        }
    }
