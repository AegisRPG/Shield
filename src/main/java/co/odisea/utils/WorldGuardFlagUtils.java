...
//		removeFlags();
        ...
        if (WorldGuardUtils.plugin == null || registry == null) {
            Shield.warn("Could not find WorldGuard, aborting registry of flag " + flag.getName());
            return null;
        }
...
//	}
     ...
     */
    public static StateFlag.State query(@NotNull org.bukkit.Location location, @Nullable RegionAssociable associable, @NotNull StateFlag... flags) {
        Validate.notNull(location, "Location cannot be null");
        Validate.notNull(flags, "Flags cannot be null");
     ...
     * @see #hasBypass(HasPlayer)
     */
    public static StateFlag.State query(@NotNull org.bukkit.Location location, @Nullable OptionalPlayer player, CustomFlags flag) {
        Validate.notNull(flag, "Flag cannot be null");
     ...
     * @see #hasBypass(HasPlayer)
     */
    public static StateFlag.State query(@NotNull HasPlayer player, CustomFlags flag) {
        Validate.notNull(player, "Player cannot be null");
        Validate.notNull(flag, "Flag cannot be null");
     ...
     * @see #hasBypass(HasPlayer)
     */
    public static StateFlag.State query(@NotNull org.bukkit.Location location, @Nullable OptionalPlayer player, @NotNull StateFlag... flags) {
     ...
     * @see #hasBypass(HasPlayer)
     */
    public static StateFlag.State query(@NotNull HasPlayer player, @NotNull StateFlag... flags) {
        Validate.notNull(player, "Player cannot be null");
     ...
     * @return effective state
     */
    public static StateFlag.State query(@NotNull org.bukkit.Location location, @NotNull WorldGuardFlagUtils.CustomFlags flag) {
        Validate.notNull(flag, "Flag cannot be null");
     ...
     * @return effective state
     */
    public static StateFlag.State query(@NotNull org.bukkit.Location location, @NotNull StateFlag... flags) {
     ...
     * @return effective state
     */
    public static StateFlag.State query(@NotNull Block block, @NotNull WorldGuardFlagUtils.CustomFlags flag) {
        Validate.notNull(block, "Block cannot be null");
     ...
     * @return effective state
     */
    public static StateFlag.State query(@NotNull Block block, @NotNull StateFlag... flags) {
        Validate.notNull(block, "Block cannot be null");
    ...
    public static String command(World world, Flag<?> flag, StateFlag.State state) {
