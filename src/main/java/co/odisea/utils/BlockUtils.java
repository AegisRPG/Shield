...
import co.odisea.utils.LocationUtils.Axis;
...
import static co.odisea.Shield.debug;
import static co.odisea.utils.ItemUtils.isPreferredTool;
...
//			debug("ChangedToolBlock CanHarvest = " + canHarvest);
	...
	public static int getBlockBreakTime(Player player, ItemStack tool, Block block) {
...
//		debug("getBlockDamage for " + block.getType());
	...
	public static float getBlockDamage(Player player, ItemStack tool, float blockHardness, float speedMultiplier, boolean isUsingCorrectTool, boolean hasDrops) {
