...
import co.odisea.features.commands.BirthdaysCommand;
...
import co.odisea.framework.interfaces.IsColoredAndNicknamed;
...
import co.odisea.models.vanish.*;
...
public class Nerd extends co.odisea.api.mongodb.models.nerd.Nerd implements PlayerOwnedObject, IsColoredAndNicknamed, Colored {
	@ToString.Exclude
