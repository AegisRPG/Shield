...
import co.odisea.api.common.utils.CompletableFutures;
import co.odisea.api.common.utils.EnumUtils;
import co.odisea.framework.interfaces.Colored;
import co.odisea.framework.interfaces.IsColoredAndNamed;
import co.odisea.utils.GlowUtils.GlowColor;
import co.odisea.utils.PlayerUtils.OnlinePlayers;
import co.odisea.utils.LuckPermsUtils;
...
//	NOBLE(ChatColor.of("#9de23d"), ChatColor.YELLOW),
	BUILDER(ChatColor.of("#02c93e"), ChatColor.GREEN),
	ARCHITECT(ChatColor.of("#02c93e"), ChatColor.GREEN),
//	MINIGAME_MODERATOR(ChatColor.of("#4cc9f0"), ChatColor.AQUA),
	MODERATOR(ChatColor.of("#07a8a8"), ChatColor.DARK_AQUA),
//	OPERATOR(ChatColor.of("#07a8a8"), ChatColor.DARK_AQUA),
	ADMIN(ChatColor.of("#4cc9f0"), ChatColor.AQUA),
	OWNER(ChatColor.of("#ff7069"), ChatColor.RED),
	;
