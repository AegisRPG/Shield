package co.odisea.framework.commands.models;

import co.odisea.Shield;
import co.odisea.api.common.annotations.Async;
import co.odisea.api.common.annotations.Disabled;
import co.odisea.api.common.annotations.Environments;
import co.odisea.api.mongodb.interfaces.PlayerOwnedObject;
import co.odisea.features.menus.MenuUtils;
...
import co.odisea.framework.commands.models.events.CommandRunEvent;
import co.odisea.framework.commands.models.events.CommandTabEvent;
import co.odisea.framework.exceptions.ShieldException;
import co.odisea.framework.exceptions.postconfigured.CommandCooldownException;
import co.odisea.framework.exceptions.postconfigured.InvalidInputException;
import co.odisea.framework.exceptions.postconfigured.PlayerNotFoundException;
...
import static co.odisea.api.common.utils.StringUtils.asParsableDecimal;
import static co.odisea.api.common.utils.StringUtils.camelCase;
import static co.odisea.api.common.utils.UUIDUtils.UUID0;
import static co.odisea.api.common.utils.Utils.getDefaultPrimitiveValue;
import static co.odisea.api.common.utils.Utils.isBoolean;
import static co.odisea.framework.commands.models.CustomCommand.getSwitchPattern;
import static co.odisea.framework.commands.models.PathParser.getLiteralWords;
import static co.odisea.framework.commands.models.PathParser.getPathString;
import static co.odisea.utils.StringUtils.COMMA_SPLIT_REGEX;
import static co.odisea.utils.Utils.getMaxValue;
import static co.odisea.utils.Utils.getMinValue;
