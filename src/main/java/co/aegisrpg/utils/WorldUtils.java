...
public class WorldUtils {
	...
	public static int getWorldSetting(World world, String setting) {
		...
		if (section == null)
			throw new ShieldException("Could not find `world-settings` section in spigot.yml");
		...
		if (defaultSection == null)
			throw new ShieldException("Could not find `world-settings.default` section in spigot.yml");

		if (!defaultSection.contains(setting))
			throw new ShieldException("Could not find `world-settings.default." + setting + "` in spigot.yml");
