...
public class MathUtils {
     ...
     * @deprecated Use {@link RandomUtils#randomInt(int)}
     */
     ...
     * @deprecated Use {@link RandomUtils#randomInt(int, int)}
     */
    @Deprecated(forRemoval = true)
     ...
     * @deprecated Use {@link Random#nextBoolean()}
     */
    @Deprecated(forRemoval = true)
     ...
     * @deprecated Use {@link RandomUtils#chanceOf(double)}
     */
    @Deprecated(forRemoval = true)
     ...
     * @deprecated Use {@link Random#nextFloat()}
     */
    @Deprecated(forRemoval = true)
     ...
     * @deprecated Use {@link RandomUtils#randomDouble(double)}
     */
    @Deprecated(forRemoval = true)
     ...
     * @deprecated Use {@link RandomUtils#randomDouble(double, double)}
     */
    @Deprecated(forRemoval = true)
...
// .longBitsToDouble(NumberUtils.doubleToLongBits(BIG_ENOUGH_INT + 1) - 1);
    ...
    /**
     * Returns true if the {@code value} is zero (using the default tolerance as upper bound)
     */
    ...
    /**
     * Returns true if the {@code value} is zero.
     *
    ...
    /**
     * Returns true if {@code a} is nearly equal to {@code b}.
    ...
    /**
     * Compatibility method for Double.isFinite from Java 1.7 and up
     * @deprecated We are not using Java 1.7; use {@link Double#isFinite(double)}
     */
    @Deprecated(forRemoval = true)
