...
public class MaterialUtils {
    ...
    public final Mineral GOLD = Mineral.builder().mineral(Material.GOLD_INGOT).extraBlocks(Set.of(Material.NETHER_GOLD_ORE)).build();
    ...
    public static @Nullable ItemStack oreToIngot(@NotNull World world, @NotNull Material ore) {
        return world.smeltItem(new ItemStack(ore), RecipeType.BLASTING);
    }

    public static @Nullable ItemStack rawToCooked(@NotNull World world, @NotNull Material raw) {
