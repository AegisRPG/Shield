...
public class JsonBuilder implements ComponentLike {
     ...
     */
    @NotNull @Contract("_ -> this")
    public JsonBuilder hover(@org.checkerframework.checker.nullness.qual.NonNull String... lines) {
     ...
     */
    @NotNull @Contract("_ -> this")
    public JsonBuilder hover(@org.checkerframework.checker.nullness.qual.NonNull List<String> lines) {
        if (lines.size() > 1)
            loreize(false);
        lore.addAll(lines);
        return this;
     ...
     */
    @NotNull @Contract("_, _ -> this")
    public JsonBuilder hover(@org.checkerframework.checker.nullness.qual.NonNull List<String> lines, String color) {
     ...
     */
    @NotNull @Contract("_, _ -> this")
    public JsonBuilder hover(@org.checkerframework.checker.nullness.qual.NonNull List<String> lines, ChatColor color) {
