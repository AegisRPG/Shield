package co.aegisrpg.models.geoip;
...
import co.aegisrpg.utils.Utils.SerializedExclude;
...
public class GeoIP implements PlayerOwnedObject {
    ...
    public static class Security {
        ...
        private static final String API_KEY = Shield.getInstance().getConfig().getString("tokens.ipqualityscore");
