...
import co.aegisrpg.utils.HttpUtils;
...
import static co.aegisrpg.api.common.utils.UUIDUtils.uuidFormat;
import static co.aegisrpg.api.common.utils.UUIDUtils.uuidUnformat;
import static co.aegisrpg.utils.Nullables.isNullOrEmpty;
...
public class SkinCache implements PlayerOwnedObject {
	...
	public boolean update() {
		...
		try {
			...
			Shield.warn("Error getting " + getNickname() + "'s current player profile: " + ex.getMessage());
			return false;
		}
	...
	private @NotNull ProfileProperty getTextureProperty(PlayerProfile profile) {
		...
		throw new ShieldException("No texture property:\n" + StringUtils.toPrettyString(profile));
	}
