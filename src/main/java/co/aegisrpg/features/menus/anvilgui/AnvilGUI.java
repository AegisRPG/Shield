package co.aegisrpg.features.menus.anvilgui;

import co.aegisrpg.features.menus.anvilgui.NMSHandler.AnvilContainer;
...
public class AnvilGUI {
    private static final NMSHandler NMS = new NMSHandler();
    /**
    ...
    private void openInventory() {
        ...
        final AnvilContainer container = NMS.newContainerAnvil(player, inventoryTitle);
        ...
        NMS.sendPacketOpenWindow(player, container, containerId, inventoryTitle);
